...
#include "../../../Configurator_ver.1.02/DLMS_client_waviot-m1_ver.1.02/hdlc_dlms_exchange.h"
...
QT_MOC_LITERAL(11, 116, 19), // "slot_vPDU_to_device"
QT_MOC_LITERAL(12, 136, 21), // "slot_HDLC_from_device"
QT_MOC_LITERAL(13, 158, 18), // "slot_PDU_to_device"
QT_MOC_LITERAL(14, 177, 3) // "pdu"

    },
    "HDLC_DLMS_exchange\0signal_HDLC_to_device\0"
    "\0data\0signal_PDU_from_device\0vpdu\0"
    "slot_connect\0uint32_t\0server\0client\0"
    "pass\0slot_vPDU_to_device\0slot_HDLC_from_device\0"
    "slot_PDU_to_device\0pdu"
};
...
void HDLC_DLMS_exchange::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->slot_vPDU_to_device((*reinterpret_cast< QVariant(*)>(_a[1]))); break;
        case 4: _t->slot_HDLC_from_device((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 5: _t->slot_PDU_to_device((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
