#ifndef _DLMS_HDLC_H_
#define _DLMS_HDLC_H_
...
//#define HDLC_TIMEOUT___NORMAL
//#define HDLC_TIMEOUT___PC
#define HDLC_TIMEOUT___GURAX
...
#define HDLC_TIMEOUT_CONNECT_RADIO (60*5)

#ifdef HDLC_TIMEOUT___NORMAL
#define HDLC_TIMEOUT_CONNECT (30)
#endif

#ifdef HDLC_TIMEOUT___PC
#define HDLC_TIMEOUT_CONNECT (1)
#endif

#ifdef HDLC_TIMEOUT___GURAX
#define HDLC_TIMEOUT_CONNECT (0)
#endif


//typedef uint8_t (*HDLC_BUF_RX)(void);
...
typedef void (*DLMS_PDU_Dispatcher_cb)(HDLC_BUF *hdlc);
typedef void (*DLMS_HDLC_Dispatcher_cb)(HDLC_BUF *hdlc, DLMS_PDU_Dispatcher_cb DLMS_pdu);
